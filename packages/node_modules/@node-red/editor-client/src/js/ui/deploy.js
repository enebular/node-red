...
RED.deploy = (function() {
    ...
    /**
     * get enebular screenshot
     */
    function getEnebularScreenshot() {
        var screenshotExist = document.querySelector('#enebular-screenshot')
        if (screenshotExist) {
            screenshotExist.remove()
        }
        var elementToExport = document.querySelector('#red-ui-workspace-chart')
        ...
        .selectAll('image.red-ui-flow-node-icon')
        .remove()
        d3
    ...
    function save(skipValidation,force) {
        if (!$("#red-ui-header-button-deploy").hasClass("disabled")) {
            ...
            $("#red-ui-header-button-deploy").addClass("disabled");            
            /**
             * enebular modification
             */
            var data = { flows: nns, screenshot: getEnebularScreenshot() };            
            /**
             * enebular modification end
             */
